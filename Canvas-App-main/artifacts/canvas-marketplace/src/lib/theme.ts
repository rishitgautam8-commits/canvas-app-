export const getTheme = (styleVersion: string) => {
  ...
  const isOpt3 = styleVersion === '3'; // Serif + Sans-serif (Xaviera + Outfit)
  const isOpt4 = styleVersion === '4'; // Thin Serif + Script (Moura + Sirelia)
  // Option 2 is Default: Sans-serif + Serif (Outfit + Mirabelle)

  return {
    // BASE TYPOGRAPHY: Clean system fonts for high readability
    ...
    headingHero: isOpt4
      ? "font-['Moura'] font-normal capitalize tracking-wide text-6xl md:text-7xl text-black leading-[1.1]" 
      : isOpt3
      ...
      : "font-['Outfit'] font-light uppercase tracking-widest text-5xl md:text-7xl text-black leading-[1.2]",
      
    headingModal: isOpt4
      ? "font-['Moura'] text-3xl text-black tracking-tight"
      : isOpt3
      ? "font-['Xaviera'] text-4xl text-black tracking-tight"
      : isOpt1
      ? "font-['Montserrat'] font-medium uppercase text-2xl text-black tracking-widest"
      : "font-['Outfit'] font-medium uppercase text-2xl text-black tracking-widest",
      
    eyebrow: isOpt4
      ? "font-['Moura'] text-xs font-bold tracking-[0.3em] text-[#6B3C9C] uppercase"
      : isOpt3
      ? "font-['Outfit'] text-[10px] font-bold uppercase tracking-[0.4em] text-[#6B3C9C]"
      : isOpt1
      ? "font-['Montserrat'] text-[10px] font-bold uppercase tracking-[0.35em] text-[#6B3C9C]"
      : "font-['Outfit'] text-[11px] font-bold uppercase tracking-[0.3em] text-[#6B3C9C]",

    headingSection: isOpt4
      ? "font-['Moura'] text-4xl sm:text-5xl text-[#6B3C9C] capitalize"
      : isOpt3
      ? "font-['Xaviera'] text-4xl sm:text-5xl text-black capitalize"
      : isOpt1
      ? "font-['Montserrat'] font-light uppercase tracking-widest text-3xl sm:text-4xl text-black"
      : "font-['Outfit'] font-light uppercase tracking-widest text-3xl sm:text-4xl text-[#6B3C9C]",
      
    bodyText: isOpt4
      ? "font-['Outfit'] text-[15px] font-light leading-[1.9] text-black/60"
      : isOpt3
    ...
    formLabel: isOpt4
      ? "font-['Outfit'] text-[11px] font-medium tracking-[0.15em] text-black/45 uppercase"
      : isOpt3
      ...
      : "font-['Outfit'] text-[11px] font-semibold uppercase tracking-[0.15em] text-black/40",
      
    inputText: isOpt4
      ? "font-['Outfit'] font-light text-base text-black placeholder:text-black/30 border-b border-[#6B3C9C]/30 focus:border-[#6B3C9C] outline-none bg-transparent py-2.5"
      : isOpt3
      ...
      : "font-['Outfit'] text-sm font-light text-black placeholder:text-black/25 border-b border-black/10 bg-transparent py-2.5 outline-none transition-colors focus:border-[#6B3C9C]",
      
    btnPrimary: isOpt4
      ? "bg-[#3D1E4A] text-[#6B3C9C] font-['Outfit'] text-xs font-semibold tracking-[0.2em] uppercase px-8 py-4 hover:bg-black transition-colors rounded-none"
      : isOpt3
      ...
      : "bg-[#6B3C9C] text-white px-8 py-4 font-['Outfit'] text-xs font-bold uppercase tracking-[0.1em] rounded-full hover:bg-black transition-colors shadow-sm",

    btnOutline: isOpt4
      ? "border border-[#6B3C9C]/50 bg-transparent text-[#6B3C9C] font-['Outfit'] text-xs font-semibold tracking-[0.2em] uppercase px-8 py-4 hover:bg-[#3D1E4A] transition-colors rounded-none"
      : isOpt3
      ...
      : "border border-black/15 bg-transparent px-8 py-4 font-['Outfit'] text-xs font-bold uppercase rounded-full text-black hover:border-black transition-colors",
      
    secondaryLink: isOpt4
      ? "font-['Outfit'] italic text-sm text-black/50 hover:text-[#6B3C9C]"
      : isOpt3
      ...
      : "font-['Outfit'] text-xs font-medium text-black/40 hover:text-[#6B3C9C] transition-colors",
      
    navLink: isOpt4
      ? "font-['Outfit'] text-sm tracking-[0.1em] text-black/55 uppercase hover:text-[#6B3C9C]"
      : isOpt3
      ...
      : "font-['Outfit'] text-[13px] font-bold uppercase tracking-wide text-black/50 hover:text-black transition-colors",
      
    badge: isOpt4
      ? "font-['Outfit'] text-xs tracking-[0.15em] text-[#6B3C9C] border border-[#6B3C9C]/50 rounded-none px-3 py-1 uppercase"
      : isOpt3
      ...
      : "px-3 py-1 bg-black/5 text-black font-['Outfit'] text-[10px] font-bold uppercase tracking-[0.15em] rounded-full",
      
    stat: isOpt4
      ? "font-['Moura'] text-5xl text-black tabular-nums"
      : isOpt3
      ? "font-['Xaviera'] text-5xl text-black tabular-nums"
      : isOpt1
      ? "font-['Montserrat'] font-light text-5xl text-black tabular-nums"
      : "font-['Outfit'] font-light text-5xl text-black tabular-nums",
      
    quote: isOpt4
      ? "font-['Sirelia'] text-2xl md:text-3xl text-black/80 leading-relaxed"
      : isOpt3
      ? "font-['Xaviera'] text-xl text-black/80 leading-relaxed"
      : isOpt1
      ? "font-['Mirabelle'] text-xl md:text-2xl text-black/80 leading-relaxed"
      : "font-['Outfit'] italic font-light text-2xl text-black/70 leading-relaxed",
    ...
    premiumTag: isOpt4
      ? "font-['Sirelia'] text-[#6B3C9C] lowercase tracking-normal text-[1.2em]" // Thin Serif + Script
      : isOpt3
      ? "font-['Outfit'] italic font-light uppercase tracking-[0.3em] text-[#6B3C9C] text-[0.6em] align-middle" // Serif + Sans
      : isOpt1
      ? "font-['Semestha'] text-[#6B3C9C] lowercase tracking-normal text-[1.4em]" // Sans + Script
      : "font-['Mirabelle'] text-[#6B3C9C] lowercase tracking-normal text-[1.2em]", // Sans + Serif
