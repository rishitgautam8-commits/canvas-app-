export const getTheme = (styleVersion: string) => {
  const isOpt1 = styleVersion === '1'; // All Montserrat
  const isOpt3 = styleVersion === '3'; // All Montserrat (Bold)
  const isOpt4 = styleVersion === '4'; // All EB Garamond
  // Option 2 (Default): All Manrope
  ...
  return {
    ...
    headingHero: isOpt4
      ...
      : isOpt1 
      ? "font-['Montserrat'] font-bold text-6xl md:text-7xl text-black tracking-tight leading-[1] uppercase" 
      : "font-['Manrope'] font-medium text-6xl md:text-7xl text-black tracking-tight lowercase leading-[1]",
    ...
    headingModal: isOpt4
      ...
      : isOpt1
      ? "font-['Montserrat'] font-bold text-3xl text-black tracking-tight uppercase"
      : "font-['Manrope'] font-semibold text-3xl text-black lowercase tracking-tight",
      
    eyebrow: isOpt4
      ? "font-['EB_Garamond'] text-xs font-semibold tracking-[0.3em] text-[#7A4B69] uppercase [font-variant:small-caps]"
      : isOpt3
    ...
    headingSection: isOpt4
      ? "font-['EB_Garamond'] font-medium text-4xl text-[#BA965B]"
      : isOpt3
      ? "font-['Montserrat'] font-black text-3xl text-black uppercase tracking-tight"
      : isOpt1
      ? "font-['Montserrat'] font-bold text-4xl sm:text-5xl text-black uppercase"
      : "font-['Manrope'] font-semibold text-3xl sm:text-5xl text-[#BA965B] lowercase",
    ...
    quote: isOpt4
      ...
      : isOpt1
      ? "font-['Montserrat'] italic font-medium text-xl md:text-2xl text-black/80 leading-relaxed"
      : "font-['Manrope'] italic font-medium text-xl text-black/70 leading-relaxed",
    ...
    // 100% MONOTYPOGRAPHY - NO FONT MIXING
    premiumTag: isOpt4
      ? "font-['EB_Garamond'] italic font-medium text-[#BA965B] lowercase tracking-normal"
      : isOpt3
      ? "font-['Montserrat'] italic font-black text-[#7A4B69] lowercase tracking-normal"
      : isOpt1
      ? "font-['Montserrat'] italic font-light text-[#BA965B] lowercase tracking-widest"
      : "font-['Manrope'] italic font-light text-[#BA965B] lowercase tracking-normal",
  };
};