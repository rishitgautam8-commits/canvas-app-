export const getTheme = (styleVersion: string) => {
  ...
  return {
    ...
    eyebrow: isOpt4
      ...
      : isOpt3
      ? "font-['Montserrat'] text-[10px] font-bold uppercase tracking-[0.4em] text-[#7A4B69]"
      : isOpt1
      ? "font-['Montserrat'] text-[10px] font-bold uppercase tracking-[0.35em] text-[#7A4B69]"
      : "font-['Manrope'] text-[11px] font-medium lowercase tracking-[0.25em] text-black/40",
      
    headingSection: isOpt4
      ? "font-['Cormorant_Garamond'] font-semibold text-4xl text-[#BA965B]"
      : isOpt3
    ...
    bodyText: isOpt4
      ...
      : "font-['Manrope'] text-[15px] font-light leading-[1.9] text-black/55 lowercase",
    ...
    formLabel: isOpt4
      ...
      : "font-['Manrope'] text-[11px] font-medium lowercase tracking-[0.15em] text-black/40",
    ...
    inputText: isOpt4
      ...
      : isOpt3
      ? "font-['Montserrat'] text-sm font-semibold text-black placeholder:text-black/30 border-b-2 border-black focus:border-[#7A4B69] outline-none bg-transparent py-2.5"
      : isOpt1
      ? "font-['Montserrat'] text-sm text-black placeholder:text-black/30 border-b border-black/15 focus:border-[#BA965B] outline-none bg-transparent py-2.5"
      : "font-['Manrope'] text-sm font-light text-black placeholder:text-black/25 border-b border-black/10 bg-transparent py-2.5 outline-none transition-colors focus:border-[#BA965B]",
    ...
    btnPrimary: isOpt4
      ...
      : isOpt3
      ? "bg-black text-white font-['Montserrat'] text-xs font-black uppercase tracking-[0.15em] hover:bg-[#7A4B69] transition-colors rounded-none px-8 py-4"
      : isOpt1
      ...
      : "bg-[#BA965B] text-white px-8 py-4 font-['Manrope'] text-xs font-semibold lowercase tracking-[0.1em] rounded-full hover:bg-black transition-colors shadow-sm",
    ...
    btnOutline: isOpt4
      ...
      : "border border-black/15 bg-transparent px-8 py-4 font-['Manrope'] text-xs font-medium lowercase rounded-full text-black hover:border-black transition-colors",
      
    secondaryLink: isOpt4
      ? "font-['EB_Garamond'] italic text-sm text-black/50 hover:text-[#BA965B]"
      : isOpt3
      ? "font-['Montserrat'] text-xs font-bold uppercase tracking-widest text-black underline decoration-2 underline-offset-4 hover:text-[#7A4B69]"
      : isOpt1
      ...
      : "font-['Manrope'] text-xs font-medium lowercase text-black/40 hover:text-[#BA965B] transition-colors",
      
    navLink: isOpt4
      ? "font-['EB_Garamond'] text-sm tracking-[0.1em] text-black/55 [font-variant:small-caps] hover:text-[#BA965B]"
      : isOpt3
      ? "font-['Montserrat'] text-xs font-black uppercase tracking-[0.1em] text-black hover:text-[#7A4B69] transition-colors"
      : isOpt1
      ? "font-['Montserrat'] text-xs font-bold uppercase tracking-[0.15em] text-black/60 hover:text-black transition-colors"
      : "font-['Manrope'] text-[13px] font-medium lowercase tracking-wide text-black/50 hover:text-black transition-colors",
    ...
    badge: isOpt4
      ...
      : "px-3 py-1 bg-black/5 text-black font-['Manrope'] text-[10px] font-medium uppercase tracking-[0.15em] rounded-full",
      
    stat: isOpt4
      ? "font-['Cormorant_Garamond'] font-semibold text-5xl text-black tabular-nums"
      : isOpt3
