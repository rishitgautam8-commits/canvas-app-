        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="w-full max-w-[1100px] h-[95vh] md:h-[85vh] bg-[var(--bg-cream)] rounded-2xl overflow-hidden shadow-2xl relative"
              onClick={(e) => e.stopPropagation()}
            >
              
              {/* FLOATING CLOSE BUTTON - Stays pinned to top right */}
              <button 
                onClick={onClose} 
                className="absolute top-4 right-4 md:top-6 md:right-6 text-white/70 hover:text-white bg-black/20 hover:bg-black/40 transition-colors z-[100] p-2.5 rounded-full backdrop-blur-md"
              >
                <X size={24} strokeWidth={1.5} />
              </button>

              {/* ENTIRE MODAL SCROLLS HERE */}
              <div className="w-full h-full overflow-y-auto hide-scroll flex flex-col">
                
                {/* DARK PURPLE HERO SECTION */}
                <div className="bg-[var(--bg-dark)] px-6 pt-12 pb-10 md:px-12 md:pt-16 md:pb-12 shrink-0 relative">
                ...
                <div className="shrink-0 p-6 md:p-12 bg-[var(--bg-cream)]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 pb-12 max-w-5xl mx-auto">
